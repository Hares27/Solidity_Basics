...
contract VerifySignature{
    ...
    function getEthSignedMessageHash( bytes32 _messageHash) public returns (bytes32) {
    ...
    function verify(address _signer,bytes32 hash,bytes memory _signature) public returns(bool){
